  ...
  return (
    ...
    <div className={`container ${styles.container}`}>
      ...
      <article className={styles.aboutContent}> 
        <h4>Hi, I'm Ron Ryan Lataza,
           a graduate with a Bachelor of Science in Information Technology. 
           ...
           detail-oriented mindset, I thrive on solving problems and exploring new tools and trends.
            ...
            and continue developing my skills to make a lasting impact in the digital world.</h4>
